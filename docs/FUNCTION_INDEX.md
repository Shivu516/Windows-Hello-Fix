...
| `GetCameraHardwareDisabledState` | True device disabled state (config flag or problem code) | `Disable/EnableTargetCameraHardware`, `VerifyCameraHardwareState` |
| `VerifyCameraHardwareState` | Retry×3 check of disabled state (100 ms) | `SetCameraHardwareStateVerified`, `Disable/EnableTargetCameraHardware` |
...
| `RecoverCameraHardware` | Enable (+ optional cycle: 350/900/500 ms sleeps) | `RestoreConfiguredCameraHardware`, `RestoreAllCameraHardware`, ghost reset |
